...
const qpT: Record<string, Record<string, string>> = {
  ...
  results: { en: "Your results", fr: "Vos résultats", es: "Tus resultados" },
  ...
  descAccessible: { en: "This quiz is accessible to everyone, great for beginners!", fr: "Ce quiz est accessible à tous, idéal pour débuter !", es: "Este quiz es accesible para todos, ideal para principiantes!" },
  descRecommended: { en: "A good level of knowledge is recommended.", fr: "Un bon niveau de connaissances est recommandé.", es: "Se recomienda un buen nivel de conocimiento." },
  descExpert: { en: "Warning, only experts will get through without mistakes.", fr: "Attention, seuls les experts passeront sans erreur.", es: "Atención, solo los expertos pasaran sin errores." },
  descIntro: { en: "Answer all {n} questions, discover detailed explanations after each answer and compare your score with friends.", fr: "Répondez aux {n} questions, découvrez les explications détaillées après chaque réponse et comparez votre score avec vos amis.", es: "Responde las {n} preguntas, descubre explicaciones detalladas tras cada respuesta y compara tu puntuación con tus amigos." },
  share: { en: "Share", fr: "Partager", es: "Compartir" },
  xpEarned: { en: "XP earned", fr: "XP gagnés", es: "XP ganados" },
...
export default function QuizPagePlayer({ quiz, locale = "en" }: Props) {
  ...
  return (
    <div className="flex gap-6">
      ...
      {/* XP popup - dispatches event to header */}
